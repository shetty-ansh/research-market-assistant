...
export const SparklesPreview = ({ className }: SparklesPreviewProps) => {
  return (
    <div
      className={
        "h-full w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md " +
        (className || "")
      }
    >
...
export function SparklesPreviewDark() {
  return (
    <div className="h-[40rem] relative w-full bg-slate-950 flex flex-col items-center justify-center overflow-hidden">
